...
export function NewsCard({
    ...
    return (
        <div
            className={cn(
                "bg-surface-light dark:bg-surface-dark rounded-[16px] p-5 shadow-soft hover:shadow-soft-hover transition-all duration-300 flex gap-5 group cursor-pointer border border-transparent hover:border-primary/20",
                className
            )}
        >
            <div
