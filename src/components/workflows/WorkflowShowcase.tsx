      ...
      <div className="relative z-10 p-6 sm:p-8">
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <Link
            ...
            className="text-xs text-[var(--muted-foreground)] hover:text-primary flex items-center gap-1 no-underline transition-colors shrink-0 mt-1"
          >
        ...
        <div className="flex gap-2 mb-4">
          <input
            ...
            maxLength={200}
            className="flex-1 px-4 py-3 rounded-xl border border-[var(--border)] bg-[var(--surface)] text-sm text-[var(--foreground)] placeholder-[var(--muted-foreground)] focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/40 transition-all shadow-sm"
          />
          <button
          ...
          <div className="flex flex-wrap gap-2 mb-2">
            ...
            {EXAMPLE_GOALS.map((example) => (
              <button
                ...
                className="text-xs px-3 py-1.5 rounded-full border border-[var(--border)] text-[var(--muted-foreground)] hover:border-primary/50 hover:text-primary hover:bg-primary/5 transition-colors cursor-pointer"
              >
                {example}
              </button>
            ))}
        ...
        {suggested && !suggesting && (
          <div className="mt-4 bg-[var(--surface)] rounded-xl border border-[var(--border)] p-5">
