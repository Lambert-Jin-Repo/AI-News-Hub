    ...
    return (
        <main className="max-w-3xl mx-auto px-4 py-8">
            ...
            <div className="prose dark:prose-invert max-w-none">
                ...
                <h2 className="text-2xl font-bold mt-10 mb-4 text-[var(--foreground)]">What We Do</h2>
                <ul className="space-y-2 mb-8 text-[var(--muted-foreground)]">
                ...
                <h2 className="text-2xl font-bold mt-10 mb-4 text-[var(--foreground)]">Our Mission</h2>
