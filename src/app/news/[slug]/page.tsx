    ...
    <main className="max-w-3xl mx-auto px-4 py-8">
      ...
      <article>
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          {timeDisplay && (
            <>
              <span className="text-xs text-[var(--border)]">
                &bull;
              </span>
        ...
        <h1 className="text-3xl font-bold text-[var(--foreground)] leading-tight mb-6">
          {article.title}
        </h1>

        {/* Thumbnail */}
        {article.thumbnail_url && (
          <div className="rounded-2xl overflow-hidden mb-6 bg-[var(--surface)]">
            <SafeImage
            ...
            {relatedArticles.map((related) => (
              ...
              >
                <div className="flex gap-3">
                  <div className="shrink-0 w-16 h-16 rounded-lg overflow-hidden bg-[var(--surface)] flex items-center justify-center">
                    {related.thumbnail_url ? (
                      ...
                      <span className="text-lg font-bold text-[var(--border)]">
                        {(related.source || "?").charAt(0)}
                      </span>
                    )}
                  </div>
                  <div className="min-w-0">
                    <h3 className="text-sm font-bold text-[var(--foreground)] leading-snug line-clamp-2 group-hover:text-primary transition-colors">
                      {related.title}
                    </h3>
