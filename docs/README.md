# AI News Hub — Documentation Index
...
|----------|-------------|
| [database-schema.md](architecture/database-schema.md) | Supabase table definitions and relationships |
| [cost-optimization.md](architecture/cost-optimization.md) | Free-tier cost strategies and limits |

## Guides

| Document | Description |
|----------|-------------|
| [maintenance.md](guides/maintenance.md) | Day-to-day ops, deploy, manual job triggers |
| [launch-checklist.md](guides/launch-checklist.md) | Pre-launch verification steps |
...
| Document | Description |
|----------|-------------|
| [instructions.md](agents/instructions.md) | Rules and conventions for AI agents |
